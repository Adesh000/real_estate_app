...
const Navbar = () => {
    return (
        <header className="p-2 m-5 dark:bg-gray-800 dark:text-gray-100 bg-white">
            <div className="container flex justify-between items-center mx-auto">
                ...
                <ul className="items-stretch hidden space-x-3 lg:flex relative right-48">
                    <li className="flex">
                        <a
                            rel="noopener noreferrer"
                            href="/"
                ...
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    <button className="self-center px-8 py-3 rounded border-2 border-blue-500 text-blue-500 mx-10">
                        Login
                    </button>
                    <button className="self-center px-8 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900 bg-blue-500 text-white">
                        Sign up
                    </button>
                </div>
